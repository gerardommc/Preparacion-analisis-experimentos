...
En el modelo [ANOVA de una vía](../Unidad 2-ANOVA I/ANOVA-I.html) aprendimos a hacer la suma de cuadrados de un tratamiento. Sin embargo en ANOVA de dos vías es necesario hacer la suma de cuadrados de dos tratamientos y comparar las sumas entre sí. La comparación de las sumas de cuadrados ($SS$) para ANOVA de dos vías tiene varias modalidades, la más utilizada y que se usa para diseños balanceados es $SS-I$, la suma de cuadrados *Tipo I*. $SS-I$ consiste en la suma secuencial de cuadrados de los tratamientos. Por ejemplo, si tenemos un experimento donde probamos el efectos de los tratamientos del factor $A$ y el factor $B$, $SS$-I consiste en hacer $SS(A)$ y utilizarla como base para medir el efecto de los tratamientos del factor $B$ ($SS(B | A)$). Para probar la interacción de $AB$, entonces se toma como referencia $SS(B | A)$, de modo que $SS(AB | B, A)$. Es por esta razón que $SS-I$ recibe el nombre de **suma de cuadrados secuencial**, pues los efectos de los tratamientos se agregarn de manera secuencial.

En **R**, $SS-I$ está implementada por default, de modo que si queremos probar los efectos de los factores $A$ y $B$ con ANOVA, $SS-I$ se puede hacer de las siguientes maneras:
...
$SS-I$ tiene bastantes problemas pues los efectos que se estiman para los factores $A$ y $B$ dependen del orden en que los introduzcamos, por ejemplo `A * B` da resultados diferentes a `B * A`, pues el modelo base de comparación es el de $SS(B)$.

En la práctica, cuando los diseños están balanceados, $SS-I$ y $SS-II$ producen los mismos resultados, pero $SS-II$ no tiene el problema que tiene $SS-I$ por utilizar suma de cuadrados secuenciales. En el siguiente tema veremos cómo se pueden hacer ambos tipos de sumas de cuadrados con **R**.
