...
```
Podemos ver que sólo hay uhn grupo (`female, high, A`) que no cumple con el supuesto de normalidad. Veamos entonces si este grupo solo puede afectar la validez de toda la prueba. Haremos ANOVA con `lm` ya que no hay ningún factor de agrupación de tratamientos experimentales (bloques).
