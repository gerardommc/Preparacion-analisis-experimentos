...
```
En ambos casos la media aritmética se parece mucho a la mediana, con lo cual inferimos que no hay razones para sospechar que $y$ sea muy diferente de una desviación normal. Veamos ahora un gráfico de cajas de una distribución que no es normal, como la distribución [log.normal](https://es.wikipedia.org/wiki/Distribuci%C3%B3n_de_Poisson):
