...
A continuación veremos cómo se hace una ANOVA en el lenguaje de programación **R**. Este lenguaje es el paquete estadístico más popular que existe y al mismo tiempo es el más completo. Para todos los análisis estadísticos que haremos en el curso utilizaremos **R**.
