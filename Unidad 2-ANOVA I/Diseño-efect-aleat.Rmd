...
Entonces, debido al error explicado por los tratamientos, la probabilidad de que estos tengan medias parecidas es muy alta $P = 0.694$, con lo que no podemos rechazar $H_0$ de no diferencias entre tratamientos. Veamos que pasa si omitimos los efectos aleatorios:
